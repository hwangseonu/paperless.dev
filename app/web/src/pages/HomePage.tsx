...
function HomePage() {
  return (
    <main>
      <section
        className={
          'relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40 bg-linear-to-b from-slate-50 to-white'
        }
      >
        <div className={'max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10'}>
          <Badge
            variant={'outline'}
            className={
              'gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 text-sm font-semibold mb-8 border'
            }
          >
            <Zap size={16} />
          ...
          <p
            className={'max-w-3xl mx-auto text-lg lg:text-xl text-slate-600 mb-12 leading-relaxed'}
          >
        ...
        <div
          className={
            'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-indigo-100/30 rounded-full blur-3xl z-0'
          }
        ></div>
      </section>
    </main>
